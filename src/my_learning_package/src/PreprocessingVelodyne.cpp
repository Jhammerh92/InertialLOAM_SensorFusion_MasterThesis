...
public:
    ...
    void processNext()
    {
        ...
        filterProximateAndHighIntensePoints(*lidar_cloud_in_no_normals, *lidar_cloud_in_no_normals, 2.0); // removes invalid points within a distance of x m from the center of the lidar
