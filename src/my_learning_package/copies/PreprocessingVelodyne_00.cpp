...
public:
    ...
    void cloudHandler( const sensor_msgs::msg::PointCloud2::SharedPtr lidar_cloud_msg) {
        ...
        filterProximateAndHighIntensePoints(*lidar_cloud_in_no_normals, *lidar_cloud_in_no_normals, 2.5); // removes invalid points within a distance of x m from the center of the lidar
